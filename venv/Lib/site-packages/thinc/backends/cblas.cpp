...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction(__pyx_t_1, "sgemm", (void (**)(void))&__pyx_f_4blis_2cy_sgemm, "void (int, int, int, int, int, float, float const *, int, float const *, int, float, float *, int)") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "daxpy", (void (**)(void))&__pyx_f_4blis_2cy_daxpy, "void (int, double, double const *, int, double *, int)") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "saxpy", (void (**)(void))&__pyx_f_4blis_2cy_saxpy, "void (int, float, float const *, int, float *, int)") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
